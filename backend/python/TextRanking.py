...
# remove tags
document1 = re.sub("</?.*?>"," <> ",document1)
# remove special characters
dcoument1 = re.sub("(\\d|\\W)+"," ",document1)

# remove stopwords
document1 = remove_stopwords(document1)
...
# remove tags
document2 = re.sub("</?.*?>"," <> ",document2)
# remove special characters
dcoument2 = re.sub("(\\d|\\W)+"," ",document2)

# remove stopwords
document2 = remove_stopwords(document2)
...
# remove tags
document3 = re.sub("</?.*?>"," <> ",document3)
# remove special characters
dcoument3 = re.sub("(\\d|\\W)+"," ",document3)

# remove stopwords
document3 = remove_stopwords(document3)
document3 = tb(document3)
